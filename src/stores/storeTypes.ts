...
import type { NodeTemplateStore } from "./nodeTemplateStore";
...
export interface GraphStore extends GraphState, NodeStore, EdgeStore, ProjectStore, NodeTemplateStore, ToolbarStore { }
