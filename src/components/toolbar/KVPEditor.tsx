  ...
  return (
    <Section title="New" className="space-x-2">
      <AutocompleteInput
        ...
        saveOn={ [ "enter" ] }
        onSave={ ( key ) => {
          const k = ( document.getElementById( "newMetadataKey" ) as HTMLInputElement );
          const v = ( document.getElementById( "newMetadataValue" ) as HTMLInputElement );
          if ( addMetadata( key, v.value ) ) {
            k.value = "";
            v.value = "";
          }
        } }
      ...
      <AutocompleteInput
        ...
        showComponent={ ( suggestion: string ) => {
