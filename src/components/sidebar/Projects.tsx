...
export function Projects() {
  ...
  const { id, name, loadGraph: importGraph } = state;
  ...
  const handleDeleteProject = ( projectId: string ) => {
    ...
    if ( projectId === id ) {
      ...
      if ( remainingProjects.length > 0 ) {
        importGraph( remainingProjects[ 0 ] ); // Load the most recently modified project
      } else {
